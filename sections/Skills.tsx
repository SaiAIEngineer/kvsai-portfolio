...
return ( <section
 ...
 >
{/* 🔥 TITLE */} <Reveal> <h2 className="text-4xl md:text-6xl font-bold text-center tracking-tight">
Skills & <span className="text-cyan-400">Technologies</span> </h2> </Reveal>
  <Reveal>
      ...
      >
        ...
        >
          ...
          <ul className="mt-5 space-y-3 text-base text-gray-300">
            ...
            <li>🌐 Node.js</li>
            <li>🔌 REST APIs</li>
            <li>🤖 API Integration (LLM APIs)</li>
  ...
  {/* 🔥 NEXT-LEVEL TECH STACK (unchanged) */}
